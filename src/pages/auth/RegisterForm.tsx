    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-full px-4 py-2 mb-4">
          ...
          <span className="text-blue-700 font-semibold text-sm">Hasta Kaydı</span>
        </div>
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Hasta Hesabı Oluşturun</h2>
        <p className="text-gray-600 text-sm">Hızlı ve güvenli kayıt ile sağlık hizmetlerinize erişin</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <span className="text-lg">📞</span>
            <span className="text-sm font-medium">Arama ile</span>
          </button>
        </div>
      </div>
